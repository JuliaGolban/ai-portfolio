...
export const DesktopTable = styled.div`
  display: none;
  margin-top: 56px;
  @media (min-width: 900px) { display: grid; }
...
export const Tab = styled.button`
  ...
  border-left: 2px solid ${({ $active }) => $active ? 'rgba(255,255,255,0.3)' : 'transparent'};
  cursor: pointer;
  text-align: left;
  transition: all 0.2s;
`;
...
export const TabIcon = styled.span`
  font-size: 12px;
  color: ${({ $active }) => $active ? 'rgba(255,255,255,0.4)' : 'rgba(255,255,255,0.15)'};
  flex-shrink: 0;
...
export const TabLabel = styled.span`
  ...
  color: ${({ $active }) => $active ? 'rgba(255,255,255,0.7)' : 'rgba(255,255,255,0.3)'};
  transition: color 0.2s;
  line-height: 1.4;
`;
...
export const PlanCell = styled.div`
  background: ${({ $accent }) => $accent ? 'rgba(255,255,255,0.03)' : '#0a0a0a'};
  padding: 22px 20px;
  display: flex;
...
export const AccordionTitle = styled.span`
  ...
  font-weight: 200;
  color: ${({ $open }) => $open ? 'rgba(255,255,255,0.85)' : 'rgba(255,255,255,0.55)'};
  transition: color 0.3s;
`;
